...
| [launcher](https://github.com/byeolang/launcher)       | The `byeol` command users actually run. Resolves versions.    | [deployment](https://byeol.io/ref/generated/ko/ac-build-structure.html#ac-build-structure-deployment) |
