...
struct speedIntegTest: byeolIntegTest {};
...
TEST_F(speedIntegTest, benchmarkArr) {
    int clc = 0;
    myObj obj1;
...
TEST_F(speedIntegTest, benchmarkNodeCreation) {
    std::uintptr_t i = 0;
...
TEST_F(speedIntegTest, benchmarkStringCreation) {
    std::uintptr_t i = 0;
...
TEST_F(speedIntegTest, benchmarkSumOfSequence) {
