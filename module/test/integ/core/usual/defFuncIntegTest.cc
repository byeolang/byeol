...
TEST_F(defFuncIntegTest, distinguishDefineLambdaOrCall) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, distinguishDefineLambdaOrCallNegative) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, lambda1) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, lambda2) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, lambda3) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, lambda4) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, lambda5Negative) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, lambda6) {
    make()
        .negative()
        .parse(R"SRC(
        main() void
...
TEST_F(defFuncIntegTest, noBodyNegative) {
    make()
        .negative()
        .parse(R"SRC(
        main() void)SRC")
...
TEST_F(defFuncIntegTest, wrongParamNegative) {
    make()
        .negative()
        .parse(R"SRC(
        main(a) void
...
TEST_F(defFuncIntegTest, nameLikeStr) {
    make()
        .parse(R"SRC(
        main(str_ str) int
            ret "wow".len()
...
TEST_F(defFuncIntegTest, defFuncReturnClass) {
    make()
        .parse(R"SRC(
        foo() A
            A()
...
TEST_F(defFuncIntegTest, defFuncDuplicateNegative) {
    make()
        .negative()
        .parse(R"SRC(
        a(n int) void
...
TEST_F(defFuncIntegTest, defFuncDuplicate) {
    make()
        .parse(R"SRC(
        a() void
            ret
...
TEST_F(defFuncIntegTest, funcHasSameNameToFieldNegative) {
    make()
        .negative()
        .parse(R"SRC(
        def A
...
TEST_F(defFuncIntegTest, funcButNoStmts) {
    make()
        .parse(R"SRC(
        foo() void:;
        main() void
...
TEST_F(defFuncIntegTest, overloadingDifferentParameters) {
    make()
        .parse(R"SRC(
        def a
            foo() int: 0
...
TEST_F(defFuncIntegTest, overloadingSimilarParameters) {
    make()
        .parse(R"SRC(
        def a
...
TEST_F(defFuncIntegTest, overloadingAmbigiousNegative) {
    make()
        .negative()
        .parse(R"SRC(
        def a
...
TEST_F(defFuncIntegTest, accessMeShouldBeComplete) {
    make()
        .parse(R"SRC(
        def a
            age int
...
TEST_F(defFuncIntegTest, simpleCtor) {
    make()
        .parse(R"SRC(
        def Person
            name str
...
TEST_F(defFuncIntegTest, multipleCtor) {
    make()
        .parse(R"SRC(
        def person
            name str
...
TEST_F(defFuncIntegTest, simpleCtorNegative) {
    make()
        .negative()
        .parse(R"SRC(
        def person
...
TEST_F(defFuncIntegTest, funcButNoStmtsNegative) {
    make()
        .negative()
        .parse(R"SRC(
...
TEST_F(defFuncIntegTest, mainFuncWithInlineBlock) {
    make()
        .parse(R"SRC(
...
TEST_F(defFuncIntegTest, mainFuncWithInlineBlock2) {
    make()
        .parse(R"SRC(
        age := 2
        main() int: foo(age, 1)
...
TEST_F(defFuncIntegTest, funcTakingFunc) {
    make()
        .parse(R"SRC(
        foo(n int) int: n + 1
        boo(f foo, n int) int
...
TEST_F(defFuncIntegTest, funcTakingClosure) {
    make()
        .parse(R"SRC(
        foo(n int) flt: n + 1.5
...
TEST_F(defFuncIntegTest, closureDontHaveImplicitCasting) {
    make()
        .negative()
        .parse(R"SRC(
        foo1(n int) int: n + 1
...
TEST_F(defFuncIntegTest, simpleClosure) {
    make()
        .parse(R"SRC(
        def a
            foo(n int) int: n + 5
...
TEST_F(defFuncIntegTest, simpleConvergence) {
    make()
        .parse(R"SRC(
        def person
            age int
...
TEST_F(defFuncIntegTest, complexConvergence) {
    make()
        .parse(R"SRC(
        def person
            age := name.len() + 20    # 1)
...
TEST_F(defFuncIntegTest, simpleNestedFunc) {
    make()
        .parse(R"SRC(
        main() int
            foo(n int) flt: n + 0.5
...
TEST_F(defFuncIntegTest, capturedNestedFunc) {
    make()
        .parse(R"SRC(
        main() int
            name := "chales"
...
TEST_F(defFuncIntegTest, capturedVariablePreservedEvenWhenAssigning) {
    make()
        .parse(R"SRC(
        main() int
            name := "chales"
...
TEST_F(defFuncIntegTest, capturedVariableCanChangeItsFields) {
    make()
        .parse(R"SRC(
        def Person
...
TEST_F(defFuncIntegTest, variableInsideBlockCanBeCaptured) {
    make()
        .parse(R"SRC(
        main() int
            res := 0
...
TEST_F(defFuncIntegTest, nestedFuncOnlyAvailableInBlockNegative) {
    make()
        .negative()
        .parse(R"SRC(
        main() int
...
TEST_F(defFuncIntegTest, TheFuncShouldNotDefineReturnTypeAsNestedFuncItHas) {
    make()
        .negative()
        .parse(R"SRC(
        foo() nestedFoo # <--- error?
...
TEST_F(defFuncIntegTest, nestedFuncShouldBeAbleToCaptureArgument) {
    make()
        .parse(R"SRC(
...
TEST_F(defFuncIntegTest, nestedFuncClosure) {
    make()
        .parse(R"SRC(
        foo(input int) int: 0
...
TEST_F(defFuncIntegTest, nestedFuncClosureWithAbstractFunc) {
    make()
        .parse(R"SRC(
        foo(input int) int
        makeClosure(n int) foo
...
TEST_F(defFuncIntegTest, nestedFuncClosureAndCallDirectly) {
    make()
        .parse(R"SRC(
        foo(input int) int
        makeClosure(n int) foo
...
TEST_F(defFuncIntegTest, closureShouldCanCaptureInMainFunc) {
    make()
        .parse(R"SRC(
        foo(inpux int) int
...
TEST_F(defFuncIntegTest, simpleLambda) {
    make()
        .parse(R"SRC(
        foo(n int) int
...
TEST_F(defFuncIntegTest, simpleLambdaInline) {
    make()
        .parse(R"SRC(
        foo(n int) int
...
TEST_F(defFuncIntegTest, voidParameterNotAllowedNegative) {
    make()
        .negative()
        .parse(R"SRC(
...
TEST_F(defFuncIntegTest, voidParameterNotAllowedInLambdaNegative) {
    make()
        .negative()
        .parse(R"SRC(
        foo() int
