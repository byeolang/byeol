...
PAIRX(OBJ_WRONG_ARGS, "%s can't eval with this argument types '%s'. they should be '%s'")
...
PAIRX(TYPE_NOT_DEDUCED, "type can't be infered into meaningful one.")
...
PAIRX(CTOR_CANT_CAST_TO_CLOSURE, "constructor can't be casted to a closure")
...
PAIRX(ELEM_TYPE_DEDUCED_NUL, "elem type has been infered to null")
PAIRX(ELEM_TYPE_DEDUCED_WRONG, "elem type has been infered to %s type")
