...
byeol 언어 문법을 알고 있는, 코드베이스를 처음 접하는 C++개발자가 체계적으로 이해할 수 있도록 구성되었습니다.
...
- **tbridge**: @ref by::tbridger "tbridger" 에 등록된 subs를 @ref by::origin "origin" 으로 삼아 생성된 @ref by::baseObj "baseObj"
